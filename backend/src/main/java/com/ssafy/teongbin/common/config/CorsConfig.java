...
public class CorsConfig {
    ...
    public CorsFilter corsFilter() {
        ...
        config.addAllowedOrigin("http://localhost:5173"); // e.g. http://domain1.com  모든 ip에 응답을 허용하겠다.
        config.addAllowedOrigin("https://i11c101.p.ssafy.io"); // e.g. http://domain1.com  모든 ip에 응답을 허용하겠다.
